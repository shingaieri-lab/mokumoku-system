...
import { THIS_MONTH, TODAY } from '../lib/constants.js';
import {
  getSources, getSourceColor, getSourceIcon,
...
export function Dashboard({ leads, currentUser, onNavigate, masterVer, isMobile }) {
