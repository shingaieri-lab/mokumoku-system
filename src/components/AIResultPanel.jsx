...
export function AIResultPanel({
  result, selLead, lead, saved, actionDate,
  saveToLead, editEmail, setEditEmail,
  copiedEmail, setCopiedEmail,
  aiGmailSaving, aiGmailSaved, saveAiGmailDraft,
  aiCalSaving, aiCalSaved, saveAiCalTodo,
  goCalendar, goLeads,
}) {
          ...
          <div style={{padding:"14px 16px",display:"flex",flexDirection:"column",gap:10}}>
            <div style={{display:"flex",gap:10,flexWrap:"wrap"}}>
              <div style={{background:"#fff",borderRadius:8,padding:"10px 16px",flex:1,minWidth:100}}>
                ...
                {result.next_action_date_offset&&<div style={{fontSize:11,color:"#6a9a7a",marginTop:2}}>{addBusinessDays(actionDate,result.next_action_date_offset)}</div>}
              </div>
