      ...
      <div style={{ padding: "14px 16px", borderBottom: "1px solid #e2f0e8", background: "#f0faf5", borderRadius: "12px 12px 0 0", position: "sticky", top: 0, zIndex: 1 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 4, flexShrink: 0, flexWrap: "wrap" }}>
            ...
            {!readOnly && <button onClick={onEdit} style={{ background: "#bbf7d0", border: "1px solid #4ade80", borderRadius: 6, cursor: "pointer", color: "#059669", fontSize: 12, padding: "3px 7px", display: "flex", alignItems: "center" }} title="編集"><PencilIcon color="#059669" /></button>}
            {!readOnly && (confirmDelete
              ...
              : <button onClick={() => setConfirmDelete(true)} style={{ background: "#fecaca", border: "1px solid #f87171", borderRadius: 6, cursor: "pointer", color: "#ef4444", fontSize: 12, padding: "3px 7px", display: "flex", alignItems: "center" }} title="削除"><TrashIcon color="#ef4444" /></button>
            )}
