...
export const S = {
  ...
  btnEditAct: { background:"#bbf7d0",border:"1px solid #4ade80",borderRadius:5,cursor:"pointer",fontSize:13,padding:"3px 5px",lineHeight:1,marginLeft:2,color:"#059669",display:"flex",alignItems:"center" },
